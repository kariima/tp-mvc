...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 05 juil. 2019 à 10:47
...
CREATE TABLE `bibliotheque` (
  ...
  `prix` text COLLATE utf8_unicode_ci,
  `date_de_parution` datetime DEFAULT NULL
...
(21, 'Les métamorphoses de l\'amour', 'Nicolas Grimaldi', 'Azerty', '', 'Livre', '1', '4', '12', '2019-07-02 00:00:00'),
(22, 'Les métamorphoses de l\'amour', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 'Les métamorphoses de l\'amour', 'Nicolas Grimaldi', 'Azerty', 'aa', 'Livre', '7', '4', '3', '2019-07-20 00:00:00');
...
CREATE TABLE `compte_lecteur` (
  ...
  `carte bancaire` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `photo` text COLLATE utf8_unicode_ci,
  `renouvellement` int(11) DEFAULT NULL,
  `mot_de_passe` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `compte_lecteur`
--

INSERT INTO `compte_lecteur` (`id`, `nom`, `prenom`, `mail`, `adresse`, `cp`, `ville`, `carte bancaire`, `photo`, `renouvellement`, `mot_de_passe`) VALUES
(1, 'Monoï', 'Vindra', 'v.monoi@gmail.com', '12 rue de la Licorne', 75009, 'Paris', '309815978368', NULL, NULL, '');
...
CREATE TABLE `emprunts` (
  ...
  `renouvellement_emprunt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Index pour la table `compte_lecteur`
--
ALTER TABLE `compte_lecteur`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `compte_lecteur`
--
ALTER TABLE `compte_lecteur`
