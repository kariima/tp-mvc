            ...
            <div class="tab-content p-b-3">
                <div class="tab-pane active" id="profile">
                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <form role="form">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" type="text" value="<?php ($_GET['photo']) ?>" placeholder="Ville">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Prénom</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="<?php ($_GET['prenom']) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Nom</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="text" value="<?php ($_GET['nom']) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Email</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" type="email" value="<?php ($_GET['mail']) ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" type="text" value="<?php ($_GET['ville']) ?>" placeholder="Ville">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Code postal</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" type="text" value="<?php ($_GET['cp']) ?>" placeholder="cp">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Carte bancaire</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" type="text" value="<?php ($_GET['carte bancaire']) ?>" placeholder="Ville">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                    ...
                    <div class="col-lg-4 pull-lg-8 text-xs-center">
                        ...
                        <h6 class="m-t-2">Ajouter une photo photo</h6>
